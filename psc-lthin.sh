...
#SBATCH --mem=30G
#SBATCH --output=/home/patelr/slurm-logs/ldak-thin-logs/psc_ldak_thin.log
#SBATCH --error=/home/patelr/slurm-errors/ldak-thin-errors/psc_ldak_thin_errors.log
...
cp psc-ldak-thin.* /home/patelr/psc/
echo "Done."
echo ""
