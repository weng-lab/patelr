...
#SBATCH --mem=30G
#SBATCH --output=/home/patelr/slurm-logs/bla-lite-logs/psc_bla_lite.log
#SBATCH --error=/home/patelr/slurm-errors/bla-lite-errors/psc_bla_lite_errors.log
...
cp psc-bla-lite.* /home/patelr/psc/
echo "Done."
echo ""
